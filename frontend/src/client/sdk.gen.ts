...
export class AvatarAssistantService {
     ...
     * @returns AssistantChatResponse Successful Response
     * @throws ApiError
     */
    public static chat(data: AvatarAssistantChatData): CancelablePromise<AvatarAssistantChatResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/avatar-assistant/chat',
     ...
     * @throws ApiError
     */
    public static approve(data: AvatarAssistantApproveData): CancelablePromise<AvatarAssistantApproveResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/avatar-assistant/approve',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
